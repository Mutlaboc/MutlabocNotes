...
// Метрика достижений: ключ счётчика и значение.
@Serializable
...
// Ответ GET /achievements: серверное состояние метрик и анлоков.
@Serializable
...
// Тело PUT /achievements/metrics: полный снапшот локальных метрик.
@Serializable
